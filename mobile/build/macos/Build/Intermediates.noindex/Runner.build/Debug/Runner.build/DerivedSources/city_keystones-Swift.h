...
#ifndef CITY_KEYSTONES_SWIFT_H
#define CITY_KEYSTONES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="city_keystones",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14city_keystones11AppDelegate")
...
SWIFT_CLASS("_TtC14city_keystones17MainFlutterWindow")
